...
class ButtonController:
    def __init__(self, fetcher: TrackFetcher, prev_pin=5, pause_pin=6, skip_pin=13):
        ...
        self.prev_btn = Button(prev_pin, pull_up=True, bounce_time=0.025)
        self.pause_btn = Button(pause_pin, pull_up=True, bounce_time=0.025)
        self.skip_btn = Button(skip_pin, pull_up=True, bounce_time=0.025)
